    ...
    for file in files:
        if file.endswith('.mp3'):
            ...
            try:
                ...
                # una solución podría ser que en lugar de songlist, sea un songdict, con la ruta de las canciones
